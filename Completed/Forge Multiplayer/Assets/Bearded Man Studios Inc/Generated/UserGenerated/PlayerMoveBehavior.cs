...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerMoveBehavior : NetworkBehavior
	{
		public const byte RPC_SHOOT = 0 + 5;
		public const byte RPC_DAMAGE = 1 + 5;
		public const byte RPC_DIE = 2 + 5;
		
		public PlayerMoveNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerMoveNetworkObject)obj;
		...
		{
			Initialize(new PlayerMoveNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerMoveNetworkObject(networker, this, createCode, metadata);
		}
